    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td, file, 126, 10, 3188);
    			add_location(tr, file, 126, 6, 3184);
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 133, 6, 3367);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", "svelte-79gxr7");
    			add_location(img, file, 131, 6, 3302);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			a1 = element("a");
    			a1.textContent = "Liv Lismonde - Antwerp";
    			t3 = space();
    			div3 = element("div");
    			table = element("table");
    			tr = element("tr");
    			...
    			attr_dev(a0, "href", "/liv-spreadsheet");
    			...
    			add_location(a1, file, 98, 2, 2267);
    			attr_dev(div0, "class", "header svelte-79gxr7");
    			add_location(div0, file, 96, 0, 2175);
    			attr_dev(th0, "class", "svelte-79gxr7");
    			add_location(th0, file, 104, 7, 2406);
    			attr_dev(th1, "class", "svelte-79gxr7");
    			add_location(th1, file, 105, 6, 2459);
    			attr_dev(th2, "class", "svelte-79gxr7");
    			add_location(th2, file, 106, 6, 2515);
    			attr_dev(th3, "class", "svelte-79gxr7");
    			add_location(th3, file, 107, 6, 2581);
    			attr_dev(th4, "class", "svelte-79gxr7");
    			add_location(th4, file, 108, 6, 2635);
    			attr_dev(th5, "class", "svelte-79gxr7");
    			add_location(th5, file, 109, 6, 2684);
    			attr_dev(th6, "class", "svelte-79gxr7");
    			add_location(th6, file, 110, 6, 2737);
    			add_location(tr, file, 103, 4, 2395);
    			attr_dev(table, "class", "svelte-79gxr7");
    			add_location(table, file, 102, 2, 2383);
    			add_location(p, file, 136, 6, 3447);
    			attr_dev(button0, "class", "svelte-79gxr7");
    			add_location(button0, file, 137, 6, 3467);
    			attr_dev(button1, "class", "svelte-79gxr7");
    			add_location(button1, file, 192, 6, 5457);
    			attr_dev(div1, "class", "filters svelte-79gxr7");
    			add_location(div1, file, 135, 4, 3419);
    			attr_dev(div2, "class", "sticky svelte-79gxr7");
    			add_location(div2, file, 129, 2, 3254);
    			attr_dev(div3, "class", "side-by-side svelte-79gxr7");
    			attr_dev(div3, "width", "100%");
    			add_location(div3, file, 101, 0, 2341);
    		},
